    ...
    <div class="scss-row">
      ...
      <div class="declaration">
        ...
        <div class="property-value">
          ...
          vuetify<i class="comma">,</i>
          bulma<i class="comma">,</i>
          bootstrap<i class="semicolon">;</i>
        </div>
      </div>
      <i class="brace">}</i>
    </div>
...
.content {
  ...
  @include font-style($font-size: 1vw, $font-weight: 300, $line-height: 120%, $color: #F8F8F2);
  padding: 30px;
  .divider {
    border: none;
    margin: 20px 0;
